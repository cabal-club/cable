...
* [3. Definitions](#3-definitions)
  + [4. BLAKE2b Parameters](#4-blake2b-parameters)
* [5. Data Model](#5-data-model)
  ...
  + [5.2 Users](#52-users)
    - [5.2.1 Names](#521-names)
    - [5.2.2 State](#522-state)
  + [5.3 Channels](#53-channels)
    - [5.3.1 Names](#531-names)
    - [5.3.2 Topics](#532-topics)
    - [5.3.3 User Membership](#533-user-membership)
    - [5.3.4 State](#534-state)
    - [5.3.5 Synchronization](#535-synchronization)
  + [5.4 Requests & Responses](#54-requests--responses)
    - [5.4.1 Time To Live](#541-time-to-live)
    - [5.4.2 Lifetime of a Request](#542-lifetime-of-a-request)
    - [5.4.3 Limits](#543-limits)
...
* [6. Wire Formats](#6-wire-formats)
  ...
  + [6.2 Messages](#62-messages)
    ...
    - [6.2.2 Requests](#622-requests)
      ...
      * [6.2.2.2 Post Request](#6222-post-request)
      * [6.2.2.3 Cancel Request](#6223-cancel-request)
      * [6.2.2.4 Channel Time Range Request](#6224-channel-time-range-request)
      * [6.2.2.5 Channel State Request](#6225-channel-state-request)
      * [6.2.2.6 Channel List Request](#6226-channel-list-request)
